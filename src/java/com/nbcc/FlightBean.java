...
public class FlightBean extends FlightBase implements Serializable {
    ...
    private boolean searchFormActive;
	...
	this.showMore(true);
	this.setSearchFormActive(false);
	this.setFlight();
    }
...
//<editor-fold defaultstate="collapsed" desc="Getters and setters">
    ...
    public boolean isSearchFormActive() {
	return searchFormActive;
    }

    public void setSearchFormActive(boolean searchFormActive) {
	this.searchFormActive = searchFormActive;
    }
